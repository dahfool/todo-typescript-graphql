...
export const ChangeStatusComponent = (props: ChangeStatusComponentProps) => (
  <ApolloReactComponents.Mutation<ChangeStatusMutation, ChangeStatusMutationVariables>
    mutation={ChangeStatusDocument} {...props} />
);

export type ChangeStatusProps<TChildProps = {}> =
  ApolloReactHoc.MutateProps<ChangeStatusMutation, ChangeStatusMutationVariables>
  & TChildProps;

export function withChangeStatus<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<TProps,
...
export const CreateTaskComponent = (props: CreateTaskComponentProps) => (
  <ApolloReactComponents.Mutation<CreateTaskMutation, CreateTaskMutationVariables>
    mutation={CreateTaskDocument} {...props} />
);

export type CreateTaskProps<TChildProps = {}> =
  ApolloReactHoc.MutateProps<CreateTaskMutation, CreateTaskMutationVariables>
  & TChildProps;

export function withCreateTask<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<TProps,
  CreateTaskMutation,
...
export const DeleteTaskComponent = (props: DeleteTaskComponentProps) => (
  <ApolloReactComponents.Mutation<DeleteTaskMutation, DeleteTaskMutationVariables>
    mutation={DeleteTaskDocument} {...props} />
);

export type DeleteTaskProps<TChildProps = {}> =
  ApolloReactHoc.MutateProps<DeleteTaskMutation, DeleteTaskMutationVariables>
  & TChildProps;

export function withDeleteTask<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<TProps,
  DeleteTaskMutation,
...
export type TaskComponentProps =
  Omit<ApolloReactComponents.QueryComponentOptions<TaskQuery, TaskQueryVariables>, 'query'>
...
export function withTask<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<TProps,
  TaskQuery,
  TaskQueryVariables,
...
export function withTasks<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<TProps,
  TasksQuery,
  TasksQueryVariables,
...
export const UpdateTaskComponent = (props: UpdateTaskComponentProps) => (
  <ApolloReactComponents.Mutation<UpdateTaskMutation, UpdateTaskMutationVariables>
    mutation={UpdateTaskDocument} {...props} />
);

export type UpdateTaskProps<TChildProps = {}> =
  ApolloReactHoc.MutateProps<UpdateTaskMutation, UpdateTaskMutationVariables>
  & TChildProps;

export function withUpdateTask<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<TProps,
  UpdateTaskMutation,
