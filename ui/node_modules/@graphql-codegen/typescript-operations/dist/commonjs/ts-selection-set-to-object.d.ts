...
export declare class TypeScriptSelectionSetToObject extends SelectionSetToObject {
    ...
    constructor(_scalars: ScalarsMap, _schema: GraphQLSchema, _convertName: ConvertNameFn, _addTypename: boolean, _immutableTypes: boolean, _parentSchemaType?: GraphQLNamedType, _selectionSet?: SelectionSetNode);
